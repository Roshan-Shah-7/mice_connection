                ...
                <div className="space-y-12 md:space-y-20">
                    {latestWorks
                        ...
                        <div
                            ...
                            itemScope
                            itemType="https://schema.org/CreativeWork"
                            onClick={() => navigate(`/crafted-moments/${work.slug || work.title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`)}
                        >
                            {/* Image Section */}
                                ...
                                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <button
                                        ...
                                        onClick={(e) => {
                                            ...
                                            navigate(`/crafted-moments/${work.slug || work.title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`);
                                        }}
                                    >
                                        View Project
                                    </button>
