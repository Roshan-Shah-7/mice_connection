...
const ConferencesPage = () => {
    ...
    const conferenceVenues = [
        {
            ...
            location: 'Kathmandu',
            description: 'Nepal\'s premier convention center with state-of-the-art facilities for large-scale international conferences.',
            features: 'Multiple halls, advanced AV, exhibition space, simultaneous translation'
        },
        {
            ...
            location: 'Kathmandu',
            description: 'Luxury hotel with extensive conference facilities and beautiful gardens for prestigious events.',
            features: 'Multiple meeting rooms, ballroom, business center, high-speed internet'
        },
        {
            ...
            capacity: 'Up to 700 delegates',
            location: 'Kathmandu',
            description: 'Modern business hotel with state-of-the-art meeting spaces and exceptional service standards.',
            features: 'Grand ballroom, breakout rooms, hybrid meeting capabilities, business lounge'
        },
        {
            ...
            location: 'Pokhara',
            description: 'Stunning lakeside resort offering unique conference venues with panoramic mountain views.',
            features: 'Outdoor venues, natural lighting, scenic views, team-building activities'
        },
        {
            ...
            location: 'Kathmandu',
            description: 'International luxury hotel brand with comprehensive conference facilities in the heart of the city.',
            features: 'Multiple conference rooms, ballroom, executive lounge, high-tech amenities'
        },
        {
            name: 'Fulbari Resort & Spa',
            category: 'boutique',
            ...
            location: 'Pokhara',
            description: 'Luxury resort with unique conference spaces overlooking the Seti River Gorge.',
            features: 'Amphitheater, garden venues, spa facilities, adventure activities'
        }
    ];
    ...
    const caseStudies = [
        {
            title: 'Asia-Pacific Business Forum 2023',
            description: 'International business conference with 500+ delegates from 25 countries',
            ...
            highlights: 'Full logistics management, cultural gala dinner, simultaneous translation, and post-conference tours.'
        },
        {
            title: 'Global Tech Summit Nepal',
            description: 'Technology conference featuring international speakers and hybrid participation',
            image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
            stats: [
                { value: '300+', label: 'Delegates' },
                { value: '15', label: 'Speakers' },
                { value: '2', label: 'Days' },
                { value: '40%', label: 'Virtual' }
            ],
            highlights: 'Hybrid conference setup, live streaming, virtual networking, and technology showcase.'
        }
    ];
    ...
    const filteredVenues = activeVenue === 'all'
        ? conferenceVenues
        : conferenceVenues.filter(venue => venue.category === activeVenue);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            {/* Conference Venues in Nepal */}
            <div className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-[#1f423b] mb-4">Conference Venues in Nepal</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Premium locations equipped for world-class conferences and events
                        </p>
                    </div>

                    <div className="flex justify-center mb-10">
                        <div className="inline-flex bg-gray-100 p-1 rounded-lg">
                            {['all', 'convention', 'luxury', 'boutique'].map((category) => (
                                <button
                                    key={category}
                                ...
                                >
                                    ...
                                    {category === 'boutique' && 'Boutique Venues'}
                                </button>
                            ))}
                        </div>
                    </div>
            ...
            {/* Case Study / Past Conference Showcase */}
            <div className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-[#1f423b] mb-4">Success Stories</h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Discover how we've delivered exceptional conference experiences
                        </p>
                    </div>
